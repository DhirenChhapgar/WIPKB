...
This extension allows to add attribute support to Lot/Serial Number so that each Lot/Serial Number's unique characteristic can be tracked. With this extension, you can do the following:
